...
class YoLov5TRT(object):
    ...
    def infer(self, raw_image_generator):
        ...
        for i in range(self.batch_size):
            ...
            print("emm2",result_boxes, result_scores, result_classid, result_proto_coef)
            ...
            #for i in range(result_masks.shape[1]):
                #for j in range(result_masks.shape[2]):
                    #if(result_masks[0][i][j] != 0.0):
                        #print(result_masks[0][i][j])
...
if __name__ == "__main__":
    ...
    engine_file_path = "build/desktop-seg.engine"
